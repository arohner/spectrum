...
(s/fdef clojure.core/map :args (s/cat :x any? :coll (s/nilable (s/* seqable?))) :ret (s/or :seq seq? :xf fn?))
(s/fdef clojure.core/map? :args (s/cat :x any?) :ret boolean?)
(s/fdef clojure.core/mapcat :args (s/cat :x any? :coll (s/nilable (s/* seqable?))) :ret (s/or :seq seq? :xf fn?))
...
(s/fdef clojure.core/seq :args (s/cat :coll (s/or :seq seq? :seqable seqable? :nil nil?)) :ret (s/nilable seq?))
